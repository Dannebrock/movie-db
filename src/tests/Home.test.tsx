...
// Testar a API (getPopularMovies)

import { getPopularMovies } from '../services/api';
vi.mock('../services/api');
const mockedGetPopularMovies = vi.mocked(getPopularMovies);

// 2. Testar se o componente MovieCard é renderizado corretamente
...
// 3. Verificar o InfiniteScroll se está funcionando corretamente
...
describe('Página Home', () => {
  ...
  it('deve renderizar os filmes da página 1 na carga inicial', async () => {    
